class DataValues {
  // About App
  static const String appName = 'Muhammad Abubakar';
  static const String appNameLong = 'wizium.info';
  static const String appDescription =
      'Hello there, I\'m Muhammad Abubakar. This is my personal website, which contains public information that anyone can find on the internet.';
  static const String appDeveloper = 'Muhammad Abubakar';
  static const String appPackage = 'dev.wizium.dev';
  static const String appVersion = '1.1.2';
  static const String appBuildNumber = '1';

  // External links
  static Uri devURL = Uri.parse('https://wizium.info');
  // static Uri hashnodeURL = Uri.parse('https://hashnode.com/@dileepabandara');
  static Uri githubURL = Uri.parse('https://github.com/abubakarl');
  static Uri linkedinURL = Uri.parse('https://linkedin.com/in/abubakarl');
  ...
  static Uri facebookURL = Uri.parse('https://www.facebook.com/Ababakarl/');
  static Uri instagramURL =
      Uri.parse('https://www.instagram.com/abubakar_69_/');
  // static Uri repoURL =
  ...
  static Uri profilesURL = Uri.parse('https://wizium.info');
  // static Uri toolkitURL = Uri.parse('https://paragonlogics.com');
  // static Uri volunteeringURL =
  //     Uri.parse('https://volunteer.dileepabandara.dev');
  // static Uri technotesURL = Uri.parse('https://techdiary.di/leepabandara.dev');
  ...
  static const String headerName = 'Muhammad Abubakar';
  ...
  static const String aboutMeFullNameDescription = 'Muhammad Abubakar\nShabbir';
  static const String aboutMeNwITitle = 'Name with Initials';
  static const String aboutMeNwIDescription = 'M.Abubakar';
  static const String aboutMeFnLTitle = 'First and Last Name';
  static const String aboutMeFnLDescription = 'Muhammad Abubakar';
  static const String aboutMeDobTitle = 'Birthday';
  static const String aboutMeDobDescription = 'April 22, 2005';
  static const String aboutMeLanguageTitle = 'Languages';
  static const String aboutMeLanguageDescription = 'Urdu & Punjabi (Native)\n'
      'English (Professional)';
  static const String aboutMeNationalityTitle = 'Nationality';
  static const String aboutMeNationalityDescription = 'Pakistani';
  ...
  static const String aboutMeLocationDescription = 'Faisalabad Punjab,Pakistan';
  static const String aboutMeWorkDomainTitle = 'Working Domain';
  static const String aboutMeWorkDomainDescription = 'wizium.info\n'
      '10:00 - 18:00 (GMT+5:00)';
  ...
  static const String aboutMeBannerWeb =
      'Visit wizium.info to find all my public profiles.';

  // Education
  static const String educationTitle = 'Education';
  static const String educationDescription =
      'My educational background is not specific in any particular way and has come from various places. In this section, you can find out about my formal and other sources from 2010 to now. So, here are my school, undergraduate institution, and other learning platforms that I\'ve been involving for education.';
  static const String educationOrg1Title = 'Govt high school Maurusipur';
  static const String educationOrg1Course1Name = 'Metric Computer Science';
  static const String educationOrg1Course1Grade =
      'Combined Maths, Physics, Chemistry and Computer Science';
  static const String educationOrg1Course1Year = 'Attempted: 2018 & 2020';
  ...
  static const String educationOrg2Title =
      'Govt Post Graduate College Maurusipur';
  static const String educationOrg2Course1Name = 'F.A IT';
  static const String educationOrg2Course1Grade =
      'Combined Computer science, Punjabi and Physical Education';
  static const String educationOrg2Course1Year = '2021 - 2023';
  ...
  static const String experienceOrg1Title = 'Muhammad Abubakar';
  static const String experienceOrg1Role = 'Solution Developer';
  static const String experienceOrg1Years = 'June 2022 - June 2024';
  static const String experienceOrg1Vales =
      'Mobile, Desktop, UI UX, Tech Support Assistant & Data Analysis.';
  static const String experienceOrg2Title = 'Paragon Logics';
  static const String experienceOrg2Role =
      'FullStack Software Developer (Flutter)';
  static const String experienceOrg2Years = 'March 2024 - ...';
  static const String experienceOrg2Vales =
      'Android, Flutter, Dart, Firebase, Git, REST API, JSON, Node, Express, mySql, Parsing & UI UX Designing.';
  ...
  static const String experienceBannerWeb =
      'Visit wizium.info for more details >>';
  ...
  static const String technotesDescription =
      'I love creating content as a hobby! It\'s a fantastic outlet for my creativity, and I enjoy expressing myself and connecting with people who share my interests. I have a blog where I can share my written ideas, and a Blog where my voice can be heard. It\'s a great way to connect with others and share my passion for technology and all things digital. Join me on this exciting journey of exploration and discovery in the tech world!';
  static const String technotesOrg1Title = 'TechNotes by Abubakar | Blog';
  ...
  static const String technotesOrg2Title = 'TechNotes by Abubakar | Blog';
  ...
  static const String technotesOrg2Vales =
      'Welcome to my Blog, where we\'ll be exploring the fascinating world of technology! Technology is constantly evolving and transforming the world we live in, creating new paths and opportunities for us to explore. In this Blog, I\'ll be sharing my personal journey of discovery and exploration in the tech world, as I learn about the latest advancements and emerging trends in the industry. From cutting-edge software and innovative solutions to groundbreaking ideas and futuristic concepts, we\'ll cover it all in this Blog. So join me on this exciting journey as we discover the ever-changing world of technology together!';
  // Contact
  ...
  static const String contactEmail = 'wizium123@gmail.com';

  // Footer
  static const String copyright =
      "Copyright ©2023 Muhammad Abubakar. All Rights Reserved.";

  static const String builtWith = "Built with Flutter and Firebase.";
}
